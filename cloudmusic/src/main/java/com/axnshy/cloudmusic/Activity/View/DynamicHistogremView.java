package com.axnshy.cloudmusic.Activity.View;
 ...
 */
public class DynamicHistogremView extends View {
    ...
    public DynamicHistogremView(Context context) {
        super(context);
        init(context);
    }

    public DynamicHistogremView(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context);
    }

    public DynamicHistogremView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(context);
    }

    public DynamicHistogremView(Context context, AttributeSet attrs, int defStyleAttr, int defStyleRes) {
